...
def matplotlib():
    ...
    # matplotlib
    x = pandas.media_valores_mensais.index
    y = pandas.media_valores_mensais.values
    ...
    plt.subplot(1, 2, 2)
    cidade_counts = pandas.df['cidade'].value_counts()
...
#tkinter
janela = Tk()
janela.title("visualização dos dados e graficos")

texto_orientacao = Label(janela, text='Visualização do data frame')
texto_orientacao.grid(column=0, row=0, padx=10, pady=10)
#botao_df = Button(janela, text='Visualizar dados', command=)
